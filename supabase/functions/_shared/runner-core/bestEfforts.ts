...
import { minettiGradePenalty } from './gpxCore.ts'
import { computeCriticalSpeed, type Effort, type CriticalSpeedResult } from './criticalSpeed.ts'
import { smoothAltitudeByDistance } from './elevationSmoothing.ts'
