...
const _GIF_REMOVED = new Set(['box_jump','rdl','bulgare','hip_thrust','step_down','reverse_nordic','side_plank_hipdrop','suitcase_carry','core_rotation','face_pull','hip_9090','knee_to_wall','open_book','monster_walk']);
